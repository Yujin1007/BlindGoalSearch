...
class BCNetwork(nn.Module):
    def __init__(self, input_dim, output_dim, seed=42, lr=1e-3, device="cpu", optim="adam"):
...
class LSTMBC(nn.Module):
    def __init__(self, input_dim, output_dim, lstm_layers=2, hidden_dim = 128, sequence_length=10, seed=42, lr=1e-3, device="cpu", optim="adam"):
...
# class BCDiscriminatorNetwork(BCNetwork):
#     def __init__(self, input_dim, output_dim, sequence_length):
#         super().__init__(input_dim, output_dim)
#         self.discriminator=LSTMDiscriminator(state_dim=input_dim, action_dim=output_dim, sequence_length=sequence_length)
#
#
#     def train_model(self, dataloader, num_epochs=10):
#         """
...
#                 # Move data to the same device as the model
#                 state_seq_batch, action_seq_batch = state_seq_batch.to(self.device), action_seq_batch.to(self.device)
#                 state_batch = state_seq_batch[:,0,:]
#                 action_batch = action_seq_batch[:,0,:]
#                 # Forward pass
#
#                 predicted_actions = self(state_batch)
#
